...
const getList = async (isNext: boolean = false) => {
  ...
  try {
    ...
    const res = await mybrc.getMyRecords({
      page: pageData.page,
  ...
  <div class="activity">
    ...
    <div class="content-list">
      <div class="list-title">
        ...
        <div>Price</div>
        <div>Seller</div>
        <div v-if="listDynamic.value !== 'list'">Buyer</div>
        <div>Time</div>
      </div>
        ...
        >
          <div class="column1 flex-align">
            <div class="flex-align">
              ...
              <div>
                <div class="color1">Inscription #{{ item.number }}</div>
